...
function sanitizeMomPayload(payload) {
  ...
  return {
    ...
    projectOwner: sanitizeString(payload.projectOwner),
    projectStatus: sanitizeString(payload.projectStatus),
    projectUpdated: sanitizeString(payload.projectUpdated),
